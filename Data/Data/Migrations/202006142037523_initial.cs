    ...
    public partial class initial : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("dbo.Branches", t => t.BranchAddressId)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.AspNetUsers", t => t.custId)
                .Index(t => t.custId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Payments", "custId", "dbo.AspNetUsers");
            DropForeignKey("dbo.OrderTrackings", "orderNo", "dbo.Orders");
            DropForeignKey("dbo.OrderItems", "Order_ID", "dbo.Orders");
            DropForeignKey("dbo.OrderItems", "ItemCode", "dbo.Items");
            ...
            DropIndex("dbo.OrderItems", new[] { "ItemCode" });
